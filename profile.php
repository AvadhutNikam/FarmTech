    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="index.php"><span class="glyphicon glyphicon-modal-window"></span>Equipments</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                    ...
                    <div class="dropdown-menu" style="width:400px;">
                        <div class="panel panel-success">
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col-md-3 col-xs-3">Sr.No</div>
                                    <div class="col-md-3 col-xs-3">Equipment Image</div>
                                    <div class="col-md-3 col-xs-3">Equipment Name</div>
                                    <div class="col-md-3 col-xs-3">Cost/Hour</div>
                                </div>
                            </div>
                ...
                <li><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span><?php echo "Hi, " . htmlspecialchars($_SESSION["name"]); ?></a>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-footer">&copy; Equipment at Service @ <?php echo date("Y"); ?></div>
            </div>
        </div>
        <div class="col-md-1"></div>
    </div>
